...
*/
#ifndef IMGPROC_DH_MICROLIB_ARGPARSE_HPP
#define IMGPROC_DH_MICROLIB_ARGPARSE_HPP

#include <string>

struct argparse_error
{
	std::string target;
	std::string what_arg;
public:
	argparse_error(const std::string& target, const std::string& what_arg)
		: target(target), what_arg(what_arg) { }
};
